...
struct Strings {
    ...
    static let estimatedNetworkFee = loc("Estimated network fee")
    static let maximumNetworkFee = loc("Maximum network fee")
    static let maximumNetworkFeeTooLarge = loc("Maximum network fee is too large.")
    static let maxPriorityFee = loc("Max priority fee")
    static let priorityFee = loc("Priority fee")
    static let maxFee = loc("Max fee")
    static let currentBaseFee = loc("Current base fee")
    static let nextBaseFeeValidation = loc("Next base fee (used for validation)")
    static let feeMustExceedValidationBaseFee = loc("The fee must exceed the base fee used for validation.")
    static let maxFeeMustCoverPriority = loc("The max fee must be greater than or equal to the max priority fee.")
    ...
    static let useSuggestedFees = loc("Use Suggested Fees")
    static let feeCapReducesPriority = loc("The fee cap currently reduces the selected priority fee.")
    static let transactionSpeed = loc("Transaction speed")
    static let transactionSpeedHint = loc("Adjust how quickly the transaction is likely to be included.")
    static let slow = loc("Slow")
    static let standard = loc("Standard")
    static let fast = loc("Fast")
    static let rapid = loc("Rapid")
    static let custom = loc("Custom")
